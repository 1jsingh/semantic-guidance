...
def load_weights():
    pretrained_dict = torch.load("data/renderer.pkl")
...
if __name__ == "__main__":
        ...
        # hyper-parameter
        parser.add_argument('--high_res', default=False, type=bool, help='resolution')
        ...
        while step < 500000:
            ...
            for i in range(batch_size):
                ...
                if args.high_res is True:
                    ground_truth.append(draw(f, width=256))
                else:
